...
class Database extends MySQL implements Stability
{
     ...
     * @param \MythicalSystemsFramework\Plugins\Interfaces\Stability|string $stability The stability of the plugin
     ...
     * @return int
     */
    public static function registerNewPlugin(string $name, string $description, string|null $homepage, string|array $require, string|null $license, Stability|string $stability, array|string $authors, string|null $support, string|null $funding, string $version, bool $isCheck): int
    {
        try {
            if ($isCheck == true) {
                return 1;
